...
/** Shared week geometry: one time column + 7 equal day tracks for header, grid, and events. */
            ...
            <div className={`${WEEK_GRID_CLASS}`}>
              ...
              {weekDays.map((day) => {
                ...
                return (
                  <div
                    key={day.toISOString()}
                    className={`relative z-0 min-w-0 overflow-hidden border-r last:border-r-0 dark:border-gray-700 ${
